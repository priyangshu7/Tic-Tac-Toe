...
//            conditions__________>>
                ...
                if (b1.equals(b2) && b2.equals(b3) && !b2.isEmpty()) {
                ...
                } else if (b9.equals(b6) && b6.equals(b3) && !b6.isEmpty()) {
                ...
                } else if (b3.equals(b5) && b5.equals(b7) && !b5.isEmpty()) {

                    Toast.makeText(this, "Winner is:  " + b3, Toast.LENGTH_LONG).show();
                    reset();

                } else if (b4.equals(b5) && b5.equals(b6) && !b5.isEmpty()) {

                    Toast.makeText(this, "Winner is:  " + b4, Toast.LENGTH_LONG).show();
                    reset();

                }else if (b2.equals(b5) && b5.equals(b8) && !b5.isEmpty()) {
